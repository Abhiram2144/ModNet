  ...
  try {
    ...
    return (
        <div className="flex flex-col h-screen bg-white text-gray-900">
            ...
            {/* Chat Area */}
            <div className="flex-1 overflow-y-auto p-4 space-y-4 max-h-[calc(100vh-130px)] bg-gray-50 scrollbar-thin scrollbar-thumb-gray-300">
                {messages.length === 0 ? (
                    ...
                    messages.map((msg) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div
                                    className={`max-w-[70%] px-4 py-2 rounded-2xl shadow-sm ${mine
                                ...
                                >
                                    ...
                                    {msg.attachment_url && (
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noreferrer"
                                            className={`block mt-1 text-xs underline ${mine ? "text-blue-100" : "text-blue-600"}`}
                                        >
                                    ...
                                    <span
                                        className={`block text-[10px] mt-1 ${mine ? "text-blue-100" : "text-gray-500"
                                            } text-right`}
                                    >
            ...
            <form
                onSubmit={handleSend}
                className="flex items-center gap-3 px-4 py-3 bg-gray-100 border-t shadow-inner"
            >
                ...
                <input
                    ...
                    className="flex-1 bg-white border border-gray-300 rounded-full px-4 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-400"
                />

                <button
                    type="submit"
                    disabled={sending}
                    className="bg-blue-600 hover:bg-blue-500 text-white rounded-full p-2 transition disabled:opacity-50"
                >
                    <Send size={18} />
                </button>
            </form>
