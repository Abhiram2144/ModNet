  ...
  return (
    <div className="flex flex-col h-screen  text-gray-900 font-inter  ">
      ...
      <div className="p-4 flex items-center w-full justify-between  h-[100px] bg-gray-100">
        ...
        <form
          onSubmit={handleSend}
          className="flex items-center justify-between   space-x-4  w-full h-full "
        >
          <div
            htmlFor="file-input"
            className="cursor-pointer flextext-gray-500 hover:text-gray-700"
          >
            <Paperclip size={20} />
            <input
              id="file-input"
          ...
          <button
            type="submit"
            disabled={sending}
            className="bg-blue-600 hover:bg-blue-500 text-white rounded-full p-3 flex justify-center items-center transition disabled:opacity-50 "
          >
            <Send size={18} />
          </button>
        </form>
