...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-[#FAFAFA] border-b border-gray-300 shadow-sm py-3 px-6 flex justify-between items-center z-50">
      {/* Logo Section */}
      <Link
        to="/home"
      ...
      <div className="flex items-center space-x-4">
        {user ? (
          <LoginButton text1 = "logout" text2 = "now"
